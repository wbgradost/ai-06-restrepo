...
\small
Start from Proposition 3, set $dN=0$, and write
$d\ln Y|_{K,L}=P_I\,dI$:
\[
d\ln W=\left[
P_I-(1-s_L)\frac{\Lambda_I}{\sigHat+\varepsilon_L}
\right]dI.
\]
Because $dI>0$,
\[
...
P_I\gtrless(1-s_L)\frac{\Lambda_I}{\sigHat+\varepsilon_L}.
\]
Proposition 3 translates this comparison into
\[
K>\Ktilde\Rightarrow\frac{d\ln W}{dI}>0,
\qquad
K<\Ktilde\Rightarrow\frac{d\ln W}{dI}<0.
\]
Yet Proposition 2 implies
\[
\frac{d\ln(W/R)}{dI}
=-\frac{\Lambda_I}{\sigHat+\varepsilon_L}<0.
\]
\begin{alertblock}{Manual evidence placeholder}
Insert the real handwritten copy of \texttt{hand/derivation-guide.md} here after
it is supplied. No synthetic handwriting has been generated.
\end{alertblock}
\end{frame}
...
\begin{frame}[fragile]{Lean proof, assumptions, and boundary}
\scriptsize
\begin{columns}[T]
